...
$sql = "SELECT * FROM certification_kpi WHERE matricNo = '$matricNo' AND sem = '$sem' AND year = '$year'";
...
<body>
    ...
    <div style="padding:0 10px;  width: 60%; margin: 0 auto;" id="challengeDiv">
    <h2>Add / Edit Certification KPI</h2>
    <form method="post" action="edit_certification_action.php" id="myForm">
    <table border="1" id="myTable">
        ...
        <tr>
            <td>Certification</td>
            <td width="1px">:</td>
            <td><input type="number" id="certificate" name="certificate" value="<?php echo $certificate; ?>" min="0"></td>
        </tr>
        <tr>
