...
$sql = "SELECT * FROM competition_kpi WHERE matricNo = '$matricNo' AND sem = '$sem' AND year = '$year'";
...
<body>
    ...
    <h2>Add / Edit Competition KPI</h2>
    <form method="post" action="edit_competition_action.php" id="myForm">
